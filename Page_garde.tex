...
\begin{center}
\Large{\textbf{Réalisation d'unn outil d’aide au développement d’un dictionnaire de la langue arabe sur des bases historiques}}
\end{center}
\end{minipage}
}
\vspace{3cm}
...
\begin{itemize}
    \item{Réalisé par:}
       \begin{description}
        ...
        \item{\textbf{MOHAMEDI Haroune}} 
        \item{\textbf{LAHBIB Abdelghani}}
       \end{description} 
\end{itemize}

\vspace{1cm}
\centering{\textbf{10-12-2018}}
